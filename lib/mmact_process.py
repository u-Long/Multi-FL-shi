...
class MmactRaw():
    """
    Pre-processes MMAct data into the UTD-MHAD format in the given destination folder.
    Expects the following folders under data_path:
        acc_phone_clip
        acc_watch_clip
        gyro_clip
        orientation_clip
    ...
    def process_inertial_data(self):
        ...
        for source in inertial_sources:
            source_root_path = os.path.join(self.data_path, f"{source}")
    ...
    def process_pose_data(self):
        ...
        data_path = os.path.join(self.data_path, "pose", "cross_view", "trainval")
...
def parse_arguments():
    ...
    parser.add_argument('--data_path', default='/home/shayulong/gitproto/Multi-FL-shi/data/mmact/sensor', type=str, help='initial data path')
    parser.add_argument('--destination_path', default='/home/shayulong/gitproto/Multi-FL-shi/data/MMAct_done', type=str, help='destination path')
